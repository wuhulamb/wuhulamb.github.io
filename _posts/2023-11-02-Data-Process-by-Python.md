...
点击 :point_right: [data-make.exe]({{ 'media/download/data-make.exe' | relative_url }}) 下载使用

**如果下载被浏览器拦截**

![download-data-make1.png]({{ 'media/image/2024/04/download-data-make1.png' | relative_url }})

![download-data-make2.png]({{ 'media/image/2024/04/download-data-make2.png' | relative_url }})
...
![data-make.png]({{ 'media/image/2024/04/data-make.png' | relative }} "start")  
*选择闻韶楼 or 天山堂/秦岭堂*
