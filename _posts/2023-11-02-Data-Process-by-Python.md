...
节假日调课处理数据的助理需要且只需要处理当天的数据（包括晚上）
{: .notice--info}
...
![holiday-checkdata.png](/media/image/2024/04/holiday-checkdata.png)

<p>b. 办公室助理异常情况表<b>星期列</b>更改</p>

![holiday-officedata.png](/media/image/2024/04/holiday-officedata.png)

补充：Excel单元格快速填充（三步）

<figure class="align-center">
  <img src="{{ site.url }}{{ site.baseurl }}/media/image/2024/04/filldata-choose.png" alt="filldata-choose.png">
  <figcaption>第一步</figcaption>
</figure> 

<figure class="align-center">
  <img src="{{ site.url }}{{ site.baseurl }}/media/image/2024/04/filldata-enter.png" alt="filldata-enter.png">
  <figcaption>第二步</figcaption>
</figure> 

<figure class="align-center">
  <img src="{{ site.url }}{{ site.baseurl }}/media/image/2024/04/filldata-fill.png" alt="filldata-fill.png">
  <figcaption>第三步</figcaption>
</figure> 

<p>c. 程序输出的到课率表<b>星期列</b>调回原值</p>

![output-data.png](/media/image/2024/04/output-data.png)
